...
export const config = {
  villageName: 'Desa Banjarsari',

  // PublicHome activities preview
  activitiesPreview: [
  ...
  // PublicKeuangan finance data
  financeData: {
    totalKas: 'Rp 74,500,000',
    pemasukanOkt: 'Rp 22,000,000',
    pengeluaranOkt: 'Rp 11,000,000',
    financeHistory: [
