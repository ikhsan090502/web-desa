...
const AppLayout: React.FC<{
...
}> = ({ isAuthenticated, setIsAuthenticated, mobileMenuOpen, setMobileMenuOpen }) => {
  ...
  if (isAdminPath && !isLoginPage) {
    ...
    return (
      <div className="flex h-screen overflow-hidden bg-slate-50">
        <Sidebar onLogout={() => handleSetAuthenticated(false)} isOpen={sidebarOpen} onClose={() => setSidebarOpen(false)} />
  ...
  return (
    <div className="min-h-screen bg-white">
      {!isLoginPage && <PublicNavigation mobileMenuOpen={mobileMenuOpen} setMobileMenuOpen={setMobileMenuOpen} />}
      <main>
        <Routes>
          ...
          <Route path="/admin/login" element={<AdminLogin onLogin={() => handleSetAuthenticated(true)} />} />
        </Routes>
      </main>
...
const PublicNavigation: React.FC<{ mobileMenuOpen: boolean; setMobileMenuOpen: (val: boolean) => void }> = ({ mobileMenuOpen, setMobileMenuOpen }) => (
  <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-16">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            <li className="flex gap-4 items-start"><span className="material-symbols-outlined text-indigo-500">location_on</span> Dukuhan Nayu, RT 01 RW 21, Banjarsari, Kec. Banjarsari,Kota Surakarta</li>
            <li className="flex gap-4 items-center"><span className="material-symbols-outlined text-indigo-500">mail</span> Dukuhannayu01@Dukuhannayu01.com</li>
          </ul>
        </div>
      </div>
